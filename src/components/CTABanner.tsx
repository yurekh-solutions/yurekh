...
const CTABanner = () => {
  ...
  return (
    <section className="py-14 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8" style={{ background: "linear-gradient(135deg, #000000 0%, #0a1a1a 40%, #0b1f1f 70%, #000000 100%)" }}>
      <motion.div
      ...
      >
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center p-6 sm:p-8 md:p-12 lg:p-16">
          {/* Left Content */}
          <div className="space-y-5 sm:space-y-6 text-center lg:text-left">
            <h2 className="text-[24px] sm:text-[28px] lg:text-[30px] font-semibold text-white leading-[1.25]">
              Ready to Build or Scale{" "}
              <span className="text-[#1BE1D3]">Your Business?</span>
            </h2>

            <p className="text-[14px] font-normal text-gray-400 leading-[1.7] max-w-lg mx-auto lg:mx-0 mt-5">
          ...
          <div
            className="relative rounded-2xl sm:rounded-3xl border border-[#1BE1D3]/10 bg-gradient-to-br from-[#0b1f1f] via-[#0a1a1a] to-black p-6 sm:p-8 overflow-hidden"
          >
            {/* Background glow */}
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5 sm:space-y-6">
                ...
                <div className="flex items-baseline gap-3">
                  ...
                  <p className="text-[13px] text-gray-400 leading-snug">average ROI our clients see</p>
                </div>
                ...
                <div className="flex items-baseline gap-3">
                  ...
                  <p className="text-[13px] text-gray-400 leading-snug">client retention year over year</p>
                </div>
              </div>
