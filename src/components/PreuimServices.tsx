...
import React, { useState } from 'react';
import { Globe, Layout, MonitorCheck, Handshake, Kanban, Smartphone, Palette, ShoppingCart, Lightbulb, Briefcase, BarChart3, Code, CheckCircle, Crown, PencilRuler, Megaphone, TrendingUp, Mail, Layers, Target, Tag, Printer, Building, Link, Smile, ListChecks, Users, Sparkles, Award, BookA, Shapes, ShieldCheck, MessageCircle, Mic, Search, GalleryHorizontal, FolderOpen, GalleryVerticalEnd, Send, PieChart as ChartPie, Zap, Trophy, Headset, Rocket, ChevronDown, ChevronUp, ArrowRight, Star } from 'lucide-react';

const servicesData = [
  {
    category: "Development Services",
    icon: Globe,
    bgImage: "https://images.pexels.com/photos/574070/pexels-photo-574070.jpeg?auto=compress&cs=tinysrgb&w=1200",
    description: "Building a robust online presence from the ground up, tailored to your business needs.",
    services: [
      {
        title: "Website Development",
        description: "Crafting custom, high-performance websites optimized for every device and user.",
        icon: Layout,
        bgImage: "https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Responsive Website",
        description: "Ensuring your site looks flawless and performs perfectly on any screen size.",
        icon: MonitorCheck,
        bgImage: "https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Web Maintenance",
        description: "Ensuring your website remains secure, updated, and performs flawlessly.",
        icon: Handshake,
        bgImage: "https://images.pexels.com/photos/1181467/pexels-photo-1181467.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Landing Pages",
        description: "Designing high-converting, targeted landing pages to maximize your campaign ROI.",
        icon: Kanban,
        bgImage: "https://images.pexels.com/photos/267389/pexels-photo-267389.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Mobile Application",
        description: "Developing native and cross-platform mobile apps for iOS and Android.",
        icon: Smartphone,
        bgImage: "https://images.pexels.com/photos/607812/pexels-photo-607812.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "UI/UX Designing",
        description: "Creating intuitive and elegant user interfaces for maximum engagement and conversion.",
      ...
      },
      {
        ...
        description: "Building secure, scalable, and feature-rich online stores to boost your sales.",
        icon: ShoppingCart,
        bgImage: "https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Microsite",
        description: "Creating dedicated, single-purpose websites for special campaigns and events.",
      ...
      },
      {
        ...
        description: "Crafting interactive digital cards that showcase your professional brand with elegance.",
        icon: Briefcase,
        bgImage: "https://images.pexels.com/photos/6755374/pexels-photo-6755374.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Custom QR Code",
        description: "Designing unique QR codes that align with your brand identity and campaigns.",
        icon: BarChart3,
        bgImage: "https://images.pexels.com/photos/4386321/pexels-photo-4386321.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Custom Software",
        description: "Developing bespoke software solutions to streamline your business operations and unique needs.",
        icon: Code,
        bgImage: "https://images.pexels.com/photos/574070/pexels-photo-574070.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "E-commerce Platform Development",
        description: "Building a robust and scalable foundation for your online retail business.",
  ...
  },
  {
    category: "Premium Digital Branding",
    icon: Crown,
    bgImage: "https://images.pexels.com/photos/355952/pexels-photo-355952.jpeg?auto=compress&cs=tinysrgb&w=1200",
    description: "Establishing an elite brand identity that resonates with your target audience and stands out from the competition.",
    services: [
      {
        title: "Elite Website Design & Development",
        description: "Architecting a visually stunning online presence that reflects your brand's luxury and exclusivity.",
        icon: PencilRuler,
        bgImage: "https://images.pexels.com/photos/355952/pexels-photo-355952.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Exclusive Social Media Management",
        description: "Managing your social media presence with sophisticated content and engagement strategies.",
        icon: Megaphone,
        bgImage: "https://images.pexels.com/photos/1148820/pexels-photo-1148820.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Decadent SEO Strategies",
        description: "Implementing top-tier SEO techniques to ensure your brand dominates search engine rankings.",
        icon: TrendingUp,
        bgImage: "https://images.pexels.com/photos/270637/pexels-photo-270637.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Opulent PPC Advertising Campaigns",
        description: "Designing high-impact pay-per-click campaigns that deliver exceptional ROI.",
      ...
      },
      {
        ...
        description: "Automating elegant and personalized email campaigns to nurture your customer relationships.",
        icon: Mail,
        bgImage: "https://images.pexels.com/photos/1591062/pexels-photo-1591062.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Sumptuous Content Creation",
        description: "Producing captivating and high-quality content that tells your brand story.",
  ...
  },
  {
    category: "Product Launch & Development",
    icon: Rocket,
    bgImage: "https://images.pexels.com/photos/73833/wormhole-space-warped-light-73833.jpeg?auto=compress&cs=tinysrgb&w=1200",
    description: "From concept to market, we execute a seamless product launch that captivates your audience and drives early adoption.",
    services: [
      {
        title: "Exclusive Market Research & Analysis",
      ...
      },
      {
        ...
        description: "Providing strategic guidance to establish the optimal pricing for your product.",
        icon: Tag,
        bgImage: "https://images.pexels.com/photos/159888/pexels-photo-159888.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Bespoke Promotional Materials",
        description: "Designing custom promotional assets that create excitement and anticipation.",
      ...
      },
      {
        ...
        description: "Planning and executing memorable launch events that generate buzz and media coverage.",
        icon: Building,
        bgImage: "https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&cs=tinysrgb&w=600"
      },
      {
        title: "Luxury Distribution Channels",
        description: "Establishing high-end distribution networks to get your product to the right audience.",
  ...
  },
  {
    category: "Elevated Branding Services",
    icon: Award,
    bgImage: "https://images.pexels.com/photos/6755374/pexels-photo-6755374.jpeg?auto=compress&cs=tinysrgb&w=1200",
    description: "Crafting a sophisticated brand identity that speaks volumes and leaves a lasting impression.",
    services: [
      {
        title: "Luxury Logo Design",
  ...
  },
  {
    category: "Print Media & Advertising",
    icon: Printer,
    bgImage: "https://images.pexels.com/photos/159888/pexels-photo-159888.jpeg?auto=compress&cs=tinysrgb&w=1200",
    description: "Bringing your brand to life in the physical world with premium print and outdoor advertising.",
    services: [
      {
        title: "Luxury Print Collateral Design",
  ...
  },
  {
    category: "Tailored Digital Work",
    icon: Target,
    bgImage: "https://images.pexels.com/photos/270637/pexels-photo-270637.jpeg?auto=compress&cs=tinysrgb&w=1200",
    description: "Precision-driven digital services designed to optimize performance and achieve your specific goals.",
    services: [
      {
        title: "Exclusive Monthly Analytics Reports",
  ...
  },
  {
    category: "Public Relations (PR)",
    icon: Megaphone,
    bgImage: "https://images.pexels.com/photos/1591062/pexels-photo-1591062.jpeg?auto=compress&cs=tinysrgb&w=1200",
    description: "Shaping your brand's public image and building strong relationships with media and key stakeholders.",
    services: [
      {
        title: "VIP Media Relations & Press Releases",
...
const ServiceCard = ({ service }: { service: any }) => {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-black/20 backdrop-blur-md border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20">
      <div 
        className="absolute inset-0 bg-cover bg-center opacity-20 group-hover:opacity-30 transition-opacity duration-500"
        style={{ backgroundImage: `url(${service.bgImage})` }}
      />
      <div className="absolute inset-0 bg-gradient-to-br from-teal-900/80 via-cyan-900/60 to-blue-900/80 group-hover:from-teal-800/90 group-hover:via-cyan-800/70 group-hover:to-blue-800/90 transition-all duration-500" />
      
      <div className="relative p-6 z-10">
        <div className="flex items-start justify-between mb-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-400 to-teal-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
            <IconComponent className="w-6 h-6 text-white" />
          </div>
          <ArrowRight className="w-5 h-5 text-cyan-300/60 group-hover:text-cyan-200 group-hover:translate-x-1 transition-all duration-300" />
        </div>
        
        <h3 className="text-xl font-bold text-white leading-tight group-hover:text-cyan-200 transition-colors duration-300 mb-3">
          {service.title}
        </h3>
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="w-8 h-0.5 bg-gradient-to-r from-transparent via-cyan-400/40 to-transparent group-hover:via-cyan-300 transition-all duration-300" />
        </div>
      </div>
    </div>
  );
...
const CategorySection = ({ category, isExpanded, toggleExpanded }: { category: any; isExpanded: boolean; toggleExpanded: () => void }) => {
  const IconComponent = category.icon;
  
  return (
    <div className="mb-8">
      <div 
        className="relative overflow-hidden rounded-3xl bg-black/30 backdrop-blur-md border border-cyan-500/30 hover:border-cyan-400/50 transition-all duration-500 cursor-pointer group hover:shadow-2xl hover:shadow-cyan-500/20"
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-teal-900/90 via-cyan-900/80 to-blue-900/90 group-hover:from-teal-800/95 group-hover:via-cyan-800/85 group-hover:to-blue-800/95 transition-all duration-500" />
        
        <div className="relative p-8 z-10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-400 to-teal-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-xl">
                <IconComponent className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-white group-hover:text-cyan-200 transition-colors duration-300">
                {category.category}
              </h2>
            </div>
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center space-x-2 bg-black/20 backdrop-blur-sm rounded-full px-4 py-2 border border-cyan-500/20">
                <span className="text-cyan-300 text-sm font-medium">{category.services.length} Services</span>
              </div>
              {isExpanded ? (
                <ChevronUp className="w-8 h-8 text-white group-hover:text-cyan-300 transition-colors duration-300" />
              ) : (
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-4xl group-hover:text-white transition-colors duration-300">
          ...
          <div className="mt-6 flex items-center space-x-4">
            <div className="flex items-center space-x-1">
              ...
              <span className="text-cyan-300 text-sm ml-2">Premium Quality</span>
            </div>
            <div className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
            <span className="text-gray-400 text-sm">Click to explore services</span>
          </div>
        </div>
      </div>
      
      <div className={`transition-all duration-700 ease-in-out ${isExpanded ? 'max-h-none opacity-100 mt-6' : 'max-h-0 opacity-0 overflow-hidden'}`}>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-cyan-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-teal-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center">
            <div className="inline-flex items-center space-x-2 bg-black/20 backdrop-blur-md border border-cyan-500/30 rounded-full px-6 py-3 mb-8">
              <Sparkles className="w-5 h-5 text-cyan-400" />
              <span className="text-cyan-300 font-medium">YUREKH FOR SOFTWARE DEVELOPMENT</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Empowering Businesses with
              <span className="block bg-gradient-to-r from-cyan-300 via-teal-300 to-blue-300 bg-clip-text text-transparent">
                Innovative Technology
              </span>
              <span className="block text-white">& Creative Strategies</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Guiding businesses on a valuable journey toward success through impactful marketing, technology, and creative strategies.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <button className="bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-400 hover:to-teal-400 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 hover:transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25">
                Discover More
              </button>
              <button className="bg-black/20 backdrop-blur-md border border-cyan-500/30 hover:border-cyan-400/50 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 hover:transform hover:scale-105">
                Watch Demo →
              </button>
            </div>
            
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-black/20 backdrop-blur-md border border-cyan-500/20 rounded-full px-6 py-3 hover:border-cyan-400/40 transition-all duration-300">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-black/20 backdrop-blur-md border border-cyan-500/30 rounded-full px-6 py-3 mb-6">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Elevating your brand with sophisticated digital solutions and unparalleled creative excellence
          </p>
        </div>
      ...
      <div className="relative overflow-hidden py-16">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-600/30 via-cyan-600/30 to-blue-600/30" />
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="bg-black/20 backdrop-blur-md border border-cyan-500/30 rounded-3xl p-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Ready to Elevate Your Brand?
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Let's discuss how our premium services can transform your digital presence
            </p>
            <button className="bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-400 hover:to-teal-400 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 hover:transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25">
              Get In Touch
            </button>
